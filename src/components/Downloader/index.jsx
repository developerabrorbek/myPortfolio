const DownloadBtn = () => {
  return (
    <>
      <a
        className="download absolute -bottom-20 right-6 hover:animate-bounce flex flex-col items-center gap-3 text-[#7ba6e8]"
        download="*"
        href="/public/Abrorbek_Abdulxamidov_CV_my.pdf"
      >
        <div className="wrapper flex w-10 h-10 justify-center items-center rounded-full bg-white">
          <svg

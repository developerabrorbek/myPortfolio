        ...
        <div className="main container mx-auto">
          <div className="main-body h-full flex flex-col items-center justify-center gap-y-6">
            ...
            <div className="socials flex gap-3 absolute bottom-6">
              ...
              <a
                href="#"
                className="text-[#0b1b37] hover:animate-bounce transition-all hover:text-blue-400"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  height="2em"
              ...
              <a
                href="#"
                className="text-[#0b1b37] hover:animate-bounce transition-all hover:text-[#73c6f2]"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  height="2em"
              ...
              <a
                href="#"
                className="text-[#0b1b37] hover:animate-bounce transition-all"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  height="2em"
